export const MENU_GROUPS = {
  archivo: [
    ...
    { label: 'Guardar', action: 'save', shortcut: 'Ctrl+S' },
    { label: 'Guardar como (.json, hoja seleccionada)…', action: 'saveAsJsonSheet' },
    { label: 'Guardar como (.json, todas las hojas)…', action: 'saveAsJson', shortcut: 'Ctrl+Shift+S' },
    { sep: true },
    { label: 'Abrir proyecto…', action: 'openProjects' },
    { label: 'Importar .json…', action: 'importJson' },
    { sep: true },
    { label: 'Exportar PNG (hoja seleccionada)…', action: 'exportPng' },
    { label: 'Exportar JPEG (hoja seleccionada)…', action: 'exportJpeg' },
    { label: 'Exportar WebP (hoja seleccionada)…', action: 'exportWebp' },
    { label: 'Exportar SVG (hoja seleccionada)…', action: 'exportSvg' },
    { label: 'Exportar PDF (hoja seleccionada)…', action: 'exportPdf' },
    { sep: true },
    { label: 'Exportar PNG (todas las hojas)…', action: 'exportPngAll' },
    { label: 'Exportar PDF (todas las hojas)…', action: 'exportPdfAll' },
  ],
  editar: [
